(() => {
    ...
    if (!document.querySelectorAll('.cards-carousel-list').length) return false;
    ...
    document.querySelectorAll('.cards-carousel-list').forEach((carousel) => {
        const default_carousel_settings = {
            spaceBetween: 30,
            slidesPerView: 1,
            simulateTouch: false,
            navigation: {
                nextEl: carousel.closest('.cards-carousel').querySelector('.cards-carousel-navigation-next'),
                prevEl: carousel.closest('.cards-carousel').querySelector('.cards-carousel-navigation-prev')
            },  
            pagination: {
                el: carousel.closest('.cards-carousel').querySelector('.cards-carousel-pagination'),
                type: 'bullets',
            },
            on: {
                beforeInit: (swiper) => {
